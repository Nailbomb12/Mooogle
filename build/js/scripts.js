...
!function (t) {
  ...
  function e(t, e, i) {
    ...
    this.element = e, this.options = t.extend({}, r, i), t(e).attr('collapsedHeight') ? this.options.collapsedHeight = parseFloat(t(e).attr('collapsedHeight')) : '', t(e).attr('moreLink') ? this.options.moreLink = '<a href="#">' + t(e).attr('moreLink') + '</a>' : '', t(e).attr('lessLink') ? this.options.lessLink = '<a href="#">' + t(e).attr('lessLink') + '</a>' : '', n(this.options), this._defaults = r, this._name = s, this.init(), window.addEventListener ? (window.addEventListener("load", c), window.addEventListener("resize", c)) : (window.attachEvent("load", c), window.attachEvent("resize", c));
  }var s = "readmore",
    ...
    var i = arguments,
        o = this.selector;return e = e || {}, "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) ? this.each(function (l) {
      if (t.data(this, "plugin_" + s)) {
        var i = t.data(this, "plugin_" + s);i.destroy.apply(i);
      }e.selector = o, t.data(this, "plugin_" + s, new a(this, e));
    }) : "string" == typeof e && "_" !== e[0] && "init" !== e ? this.each(function (l) {
